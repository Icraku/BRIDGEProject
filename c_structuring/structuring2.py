...
# ------------------------
# STRUCTURE RECORD
# Uses NARFullRecord (all fields) for extraction,
# then splits output into required vs supplementary fields.
...
def run_structuring_pipeline(
    ...
    **kwargs,
    ...
    for record_id in tqdm(image_ids):
        ...
        # ------------------------
        # MAP TO SCHEMA (uses required fields only, same as before)
        try:
