...
FIELD_TYPES = {
    "date_of_birth": "date", "anc_visits": "int", "apgar_10m": "int",
    "apgar_1m": "int", "apgar_5m": "int", "baby_age_in_days": "int",
    "birth_date": "date", "birth_weight": "int", "blood_group": "str",
    "born_before_arrival": "bool", "born_where": "str",
    "admission_date": "date", "date_estimated_delivery_date": "date",
    "delivery_type": "str", "diastolic_blood_pressure": "int",
    "gestation_in_weeks": "int", "gestation_type": "str",
    "given_anti_D_medication": "str", "had_cs": "str",
    "has_apnoea": "bool", "has_convulsions": "bool", "has_diarhoea": "bool",
    "has_difficulty_breathing": "bool", "has_difficulty_feeding": "bool",
    "has_fever": "bool", "has_vomiting": "bool", "head_circumference": "int",
    "is_floppy": "bool", "is_multiple_delivery": "bool", "length": "int",
    "multiple_delivery_num": "int", "mum_age_in_years": "int",
    "mum_given_HBIG_treatment": "bool", "mum_had_antepartum_haemorrhage": "bool",
    "mum_had_diabetes": "bool", "mum_had_hepatitis_b": "bool",
    "mum_had_hypertension_in_pregnancy": "bool", "mum_had_vdrl": "bool",
    "mum_has_anc_ultrasound": "bool", "mum_on_arvs": "bool",
    "mum_pmtct_status": "bool", "parity_abortions": "int", "parity_live": "int",
    "passed_meconium": "bool", "passed_urine": "bool", "prolonged_labour": "bool",
    "pulse_oximetry": "int", "pulse_rate": "int", "rapture_of_membrane": "str",
    "record_type": "str", "respiratory_rate": "int", "rhesus": "str", "sex": "str",
    "systolic_blood_pressure": "int", "temparature": "float",
    "time_birth": "time", "time_seen": "time", "was_resuscitated": "bool",
    "weight": "int",
    # PAGE 2
    "skin": "str", "jaundice": "str", "appearance": "str", "cry": "str",
    "has_crackles": "bool", "has_grunting": "bool", "has_good_air_entry": "bool",
    "has_central_cyanosis": "bool", "chest_indrawing": "bool",
    "xiphoid_retraction": "str", "intercostal_retraction": "str",
    "capillary_refill_in_seconds": "float", "pallor": "str",
    "has_murmur": "bool", "has_bulging_fontanelle": "bool", "is_irritable": "bool",
    "tone": "str", "is_distended": "bool", "umbilicus": "str",
    "has_birth_defects": "bool", "rbs_measured": "bool", "given_bilirubin": "bool",
    "primary_admission_diagnosis": "str", "secondary_admission_diagnosis": "str",
    "given_vitamin_k": "bool", "given_bcg": "bool", "given_chlorhexidine": "bool",
    "given_prophylaxis_pmtct": "bool", "prescribed_transfusion": "bool",
    "prescribed_phototherapy": "bool", "prescribed_cpap": "bool",
    "prescribed_iv_fluids": "bool", "prescribed_antibiotics": "bool",
    "prescribed_feeds": "bool", "prescribed_opv": "bool",
    "prescribed_surfactant": "bool", "prescribed_caffeine_citrate": "bool",
    "prescribed_oxygen": "bool", "prescribed_kmc": "bool",
